...
function TableListRiwayat() {
  ...
  const handleClick = (id) => {
    history.push(`/admin/detail/${id}`); // Perubahan disini, menambahkan '/admin' sesuai dengan konfigurasi layout
  };
        ...
        <Row>
          <Col md="12">
            <Card className="strpied-tabled-with-hover">
              <Card.Header>
                <Card.Title as="h4">Riwayat Permintaan</Card.Title>              
...
export default TableListRiwayat;
